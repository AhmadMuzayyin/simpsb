    ...
    <div class="row">
        <div class="col-xl-12 col-md-12 mb-4">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route('siswa.daftar_ulang.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <button type="submit" class="btn btn-{{ isset($daftar_ulang) ? 'warning' : 'primary' }} mt-3">{{ isset($daftar_ulang) ? 'Update Data' : 'Daftar Ulang' }}</button>
                    </form>
                </div>
            </div>
        </div>
