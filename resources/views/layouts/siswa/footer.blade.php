...
<!-- Page level plugins -->
<script src="{{ url('home/vendor/chart.js/Chart.min.js') }}"></script>

<!-- Page level custom scripts -->
<script src="{{ url('home/js/demo/chart-area-demo.js') }}"></script>
<script src="{{ url('home/js/demo/chart-pie-demo.js') }}"></script>
